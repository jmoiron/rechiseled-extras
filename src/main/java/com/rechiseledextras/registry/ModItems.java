...
public class ModItems {
    ...
    // Factory block items - regular variants
    ...
    public static final RegistryObject<Item> FACTORY_WIREFRAMEBLUE = ITEMS.register("factory_wireframeblue",
            () -> new BlockItem(ModBlocks.FACTORY_WIREFRAMEBLUE.get(), new Item.Properties()));
    public static final RegistryObject<Item> FACTORY_WIREFRAMEWHITE = ITEMS.register("factory_wireframewhite",
            () -> new BlockItem(ModBlocks.FACTORY_WIREFRAMEWHITE.get(), new Item.Properties()));

    // Factory block items - connecting variants (CTM)
    ...
    public static final RegistryObject<Item> FACTORY_WIREFRAME_CONNECTING = ITEMS.register("factory_wireframe_connecting",
            () -> new ConnectingBlockItem(ModBlocks.BLOCKS.getEntries().stream()
                    ...
                    .findFirst().get().get(), new Item.Properties()));
    public static final RegistryObject<Item> FACTORY_WIREFRAMEBLUE_CONNECTING = ITEMS.register("factory_wireframeblue_connecting",
            () -> new ConnectingBlockItem(ModBlocks.BLOCKS.getEntries().stream()
                    .filter(e -> e.getId().getPath().equals("factory_wireframeblue_connecting"))
                    .findFirst().get().get(), new Item.Properties()));
    public static final RegistryObject<Item> FACTORY_WIREFRAMEWHITE_CONNECTING = ITEMS.register("factory_wireframewhite_connecting",
            () -> new ConnectingBlockItem(ModBlocks.BLOCKS.getEntries().stream()
                    .filter(e -> e.getId().getPath().equals("factory_wireframewhite_connecting"))
                    .findFirst().get().get(), new Item.Properties()));

    // Factory block items - vertical CTM variants (regular)
    public static final RegistryObject<Item> FACTORY_COLUMN = ITEMS.register("factory_column",
            () -> new BlockItem(ModBlocks.FACTORY_COLUMN.get(), new Item.Properties()));
    public static final RegistryObject<Item> FACTORY_VENT = ITEMS.register("factory_vent",
            () -> new BlockItem(ModBlocks.FACTORY_VENT.get(), new Item.Properties()));

    // Factory block items - vertical CTM variants (connecting)
